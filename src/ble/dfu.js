...
//   - co/candyhouse/sesame/ble/os3/CHHub3Device.kt:213-226       updateFirmwareBleOnly()
//                                          :316-318              MOVE_TO publish = onOTAProgress
...
//         (CHHub3Device.kt:316-318 onOTAProgress(payload.first()))。
//
 ...
 * onOTAProgress(payload.first()) を delegate に投げるのと同じ (CHHub3Device.kt:316-318 /
...
export async function updateFirmwareBleOnly(session, { onProgress, timeoutMs } = {}) {
  // MOVE_TO の data は byteArrayOf() = 空 (CHHub3Device.kt:218)。
  ...
  try {
    ...
    // request() は resultCode!=0 を BleResultError で reject 済み (CHHub3Device.kt:221-222 の
