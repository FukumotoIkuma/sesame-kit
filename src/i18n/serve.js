...
Examples:
  ...
  sesame rpc --paths                          # connection info for other languages as JSON`,
    ...
    "serve.sum.accessRegisterCards": "[experimental] bulk-register read IC cards to the cloud DB (postCards)",
    "serve.desc.registerCardsCards": "card records to register: [{cardID, cardName, cardType}, ...]",
...
例:
  ...
  sesame rpc --paths                          # 他言語から繋ぐ接続情報を JSON で`,
    ...
    "serve.sum.accessRegisterCards": "[experimental] 読み取った IC カードをクラウド DB に一括登録 (postCards)",
    "serve.desc.registerCardsCards": "登録するカードレコード: [{cardID, cardName, cardType}, ...]",
