 ...
 */
/**
 * 生体登録の収集仕様 (BIO_LIST の 1 entry)。正準型は biometric.js が所有する。
 * CLI/serve が `@sesame-kit/core/ble` 経由で型参照できるよう再公開する。
 * (Bot2Commands は上で値として re-export 済みのため型としても解決可能。)
 * @typedef {import("./biometric.js").BioSpec} BioSpec
 */
/**
 ...
 * (Bot2Commands は上で値として re-export 済みのため型としても解決可能。)
 */
export type BioSpec = import("./biometric.js").BioSpec;
/**
 * SesameBle コンストラクタ opts。
 */
...
export { NobleTransport, createBleTransport, advToDeviceUUID, parseAdvertisement, scanSesames, listNearbyDevices, peripheralToDiscovery, bleWasUsed } from "./transport.js";
...
export { BiometricCommands, handleBiometricPublish, parseTouchCard, parseTouchFace, parseRemoteNanoTrigger, remoteNanoTriggerDelayData, radarSensitivityData, insertSesameData as biometricInsertSesameData, removeSesameData as biometricRemoveSesameData, createEnrollCollector, collectBiometricList, BIO_LIST } from "./biometric.js";
