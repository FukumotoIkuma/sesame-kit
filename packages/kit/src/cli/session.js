...
import { SesameBle, capabilitiesForModel } from "@sesame-kit/core/ble";
...
/** @typedef {import("@sesame-kit/core/client").SesameHub3} SesameHub3 */
 ...
 * @typedef {{ kind: string, entry: SessionEntry, ble: (import("@sesame-kit/core/ble").SesameBle & { lastStatus?: MechStatus|null })|null }} SessionDevice
 */
