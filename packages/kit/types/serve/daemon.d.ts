export class Daemon {
     ...
     */
    dispatchMessage(conn: Connection, raw: string): Promise<import("@sesame-kit/core/jsonrpc").RpcResponse | null>;
    /**
...
export type HubLike = {
    ...
    tokenStore?: import("@sesame-kit/core/tokens").TokenStore | undefined;
    config?: {
