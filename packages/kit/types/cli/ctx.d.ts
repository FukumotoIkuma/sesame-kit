...
export type CliLoadCtx = {
    ...
    paths: import("@sesame-kit/core/paths").ConfigPaths;
    configStore: import("@sesame-kit/core/config").ConfigStore;
...
export type CliCtx = {
     ...
     *   connect → fn(hub, {opts, paths}) → close。
     */
    withHub: (fn: (hub: import("@sesame-kit/core/client").SesameHub3, extra: HubExtra) => any) => Promise<any>;
    /**
     *   withHub に加え refreshAccount() 済み customerInfo を extra へ渡す。
     */
    withAccount: (fn: (hub: import("@sesame-kit/core/client").SesameHub3, extra: HubExtra & {
        customerInfo: any;
    }) => any) => Promise<any>;
    prompts: {
     ...
     * SesameBle ファサード生成。
     */
    makeBle: (opts: any) => import("@sesame-kit/core/ble").SesameBle;
    /**
